...
export class SidebarComponent {
  ...
  ngOnInit() {
    ...
    this.chatService.chatSearchVisibility$.subscribe(
      (isVisible) => (this.isChatSearchVisible = isVisible)
    );
  ...
  toggleSearch() {
    ...
    if (!this.isSearchActive) {
      this.keyword = '';
      this.onSearchInput(this.keyword);     
    }
  }
  userlogin() {  
  ...
  createNewChat() {
    ...
    this.router.navigate(['/dashboard']); //Sneha
    this.chatService.createNewChat(true); //Sneha
  }
