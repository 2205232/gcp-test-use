...
//  private apiUrl = 'http://localhost:3000/api';
  ...
  sendChatRequest(payload: any): Observable<any> {
    const apiUrl = 'https://cors-anywhere.herokuapp.com/https://dgsahayak-dev.gcpwkshpdev.com/search/genie/search';
    ...
    return this.http.post<any>(apiUrl,payload, { headers, responseType: 'text' as 'json' }).pipe(
      catchError(error => {
