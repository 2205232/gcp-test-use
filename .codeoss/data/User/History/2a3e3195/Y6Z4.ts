...
//  private apiUrl = 'http://localhost:3000/api';
  ...
  sendChatRequest(payload: any): Observable<any> {
    const URL ='https:cors-anywhere.herekuapp.com/https://dgsahayak-dev.gcpwkshpdev.com/search/genie/search';
    ...
    return this.http.post<any>(URL,payload, { headers, responseType:'text'as'json' }).pipe(
      catchError(error => {
