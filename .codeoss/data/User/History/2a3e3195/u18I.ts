...
export class ChatServiceService {
  ...
  private chatSearchVisibility = new BehaviorSubject<boolean>(false); //Sneha
  private showChatWindow = new BehaviorSubject<boolean>(false); //Sneha
  chatSearchVisibility$ = this.chatSearchVisibility.asObservable();//Sneha
  showChatWindow$ = this.showChatWindow.asObservable(); //Sneha
  ...
  createNewChat(isVisible: boolean) {
    this.showChatWindow.next(isVisible);
    this.chatCounter++;
  ...
  toggleChatSearchVisibility(isVisible: boolean){ //Sneha
    this.chatSearchVisibility.next(isVisible);
  }
